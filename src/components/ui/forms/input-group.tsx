  ...
  "flex h-auto cursor-text items-center justify-center gap-1.5 py-1 text-sm font-medium text-muted-foreground select-none group-data-[disabled=true]/input-group:opacity-50 [&>kbd]:rounded-[calc(var(--radius)-5px)] [&>svg:not([class*='size-'])]:size-4",
  {
    variants: {
      align: {
        ...
        "block-start":
        "order-first w-full justify-start px-2.5 pt-1.5 group-has-[>input]/input-group:pt-1.5 [.border-b]:pb-1.5",
        "block-end":
        "order-last w-full justify-start px-2.5 pb-1.5 group-has-[>input]/input-group:pb-1.5 [.border-t]:pt-1.5",
      },
    },
    defaultVariants: {
      align: "inline-start",
