...
- Current published version: `0.3.3`
- Current latest git tag: `v0.3.3`
- Current latest GitHub Release: `v0.3.3`
...
- `v0.3.3` is the current published patch release on npm, git tags, and GitHub Releases
...
- `v0.3.2` carried those omitted source updates so the published package and `main` CI baseline lined up again
- `v0.3.3` adds the post-`v0.3.2` layout-system work and stabilizes Playwright visual snapshots by freezing time and tolerating minor Linux font rasterization drift
